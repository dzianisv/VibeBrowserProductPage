        ...
        <div className="mx-auto max-w-3xl">
          ...
          <article className="mt-5">
            <header className="pb-8">
              ...
              <h1 className="mt-4 font-serif text-3xl font-semibold leading-tight tracking-tight text-slate-950 md:text-5xl">
                {post.title}
              </h1>
              <p className="mt-4 max-w-2xl text-base leading-7 text-slate-600 md:text-lg md:leading-8">{post.description}</p>
              {post.tags.length > 0 && (
          ...
          {relatedPosts.length > 0 && (
            <section className="mt-12 border-t border-slate-200 pt-8">
              <p className="text-sm font-semibold text-purple-700">Read next</p>
              <h2 className="mt-2 font-serif text-2xl font-semibold text-slate-950">Related posts</h2>
              <div className="mt-6 space-y-6">
                {relatedPosts.map((relatedPost) => (
                  ...
                  >
                    ...
                    <h3 className="mt-3 font-serif text-2xl font-semibold tracking-tight text-slate-950">
                      <Link
