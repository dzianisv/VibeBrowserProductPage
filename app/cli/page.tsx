              ...
              <div className="min-w-0 space-y-6">
                ...
                <Card className="min-w-0 border-[rgba(136,146,176,0.15)] bg-[rgba(5,8,16,0.96)]">
                  <CardContent className="p-6">
                    ...
                    <p className="text-sm text-[#b7c0db]">
                      Need richer tool orchestration? Use the same package via <Link href="/mcp-stdio" className="text-[#b4b4ff] hover:text-[#d8dcff] hover:underline">/mcp setup</Link> without changing the execution layer.
                    </p>
                  </CardContent>
                </Card>
              </div>
