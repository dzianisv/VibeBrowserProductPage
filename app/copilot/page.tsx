...
const copilotConfig: ProfessionConfig = {
  ...
  description: 'Already paying for GitHub Copilot? Use it to drive your browser. Vibe turns Copilot into an agent that can click, type, and automate workflows for recruiting, sales, and operations.',
  showDownloadButtons: true,
  features: [
    { icon: 'Code', title: 'Bring Your Copilot Subscription', description: 'Use your existing GitHub Copilot subscription as your AI backend. No new bills.' },
    { icon: 'Globe', title: 'Runs in Your Real Browser', description: 'Automates work in the tabs you already use. No "headless" magic that breaks on login screens.' },
    { icon: 'Workflow', title: 'Routine Task Automation', description: 'Turn repetitive clicking into reusable flows your team can run on demand.' },
    ...
    { icon: 'Users', title: 'Built for Non-Engineers', description: 'Recruiters, sales, and ops teams can finally use the company AI subscription.' },
    { icon: 'Lock', title: 'Local-First Privacy', description: 'Run local by default. Cloud model APIs are optional and user-controlled.' },
    { icon: 'Shield', title: 'Human-in-the-Loop Control', description: 'You approve every action. Vibe doesn&apos;t click "Submit" until you say so.' },
  ],
  workflows: [
