...
const enterpriseConfig: EnterpriseConfig = {
  ...
  heroDescription: 'Built for professionals in finance, law, healthcare, and other regulated industries who need AI automation without compliance risk. As highlighted by Microsoft Research (2024), "agent-to-agent communications in context-rich enterprise environments markedly increase privacy risk." Vibe solves this by running locally or in a TEE. Includes Google Workspace (Gmail + Calendar), skills library, MCP server access for other agents, and an internal secrets vault.',
  ...
  features: [
    { icon: 'Shield', title: 'TEE Protection', description: 'Hardware-encrypted AI inference. Solves "Privacy Risks of LLM Agents" (Microsoft Research 2024) by ensuring even cloud providers cannot see your data.' },
