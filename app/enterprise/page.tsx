...
const enterpriseConfig: EnterpriseConfig = {
  ...
  heroDescription: 'Built for professionals in finance, law, healthcare, and other regulated industries who need AI automation without compliance risk. As highlighted by Microsoft Research (2024), "agent-to-agent communications in context-rich enterprise environments markedly increase privacy risk." Vibe solves this by running locally or self-hosted. Includes Google Workspace (Gmail + Calendar), skills library, MCP server access for other agents, and an internal secrets vault.',
  ...
  features: [
    { icon: 'Server', title: 'Self-Hosted', description: 'Run DeepSeek, Llama, Qwen, or any model locally via Ollama. One-click setup, zero cloud dependency. Complete data control.' },
  ...
  testimonials: [],
  faqs: [
    { question: "What models can I self-host?", answer: "Any model that exposes an OpenAI-compatible API. Popular choices include DeepSeek, Llama 3, Mistral, and Qwen — all available through Ollama with one-command install. See docs.vibebrowser.app/self-hosted-llm for setup." },
    { question: "Is this compliant with SEC/FINRA regulations?", answer: "Yes. With self-hosted deployment, all data remains under your control. We provide complete audit logs for regulatory examinations." },
    ...
    { question: "Can I use GPT-4 or Claude with Vibe?", answer: "Yes, but only for non-sensitive tasks. For sensitive data, we recommend using local AI or self-hosted models." },
  ],
  showSecurity: true,
  showPricing: true,
  customPricing: {
