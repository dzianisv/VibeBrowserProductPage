            ...
            <Accordion type="single" collapsible className="w-full space-y-3">
              <AccordionItem value="what" className="border border-[#1e1e1e] bg-[#111111] rounded-lg px-5">
                ...
                <AccordionContent className="text-[#9aa0a6] pb-5 leading-relaxed">
                  OpenClaw Mobile is the phone-native version of OpenClaw — a personal AI assistant you can launch and use from your phone without buying hardware or managing a home server. It connects to a managed OpenClaw instance deployed on OpenClaw Box infrastructure.
                </AccordionContent>
              </AccordionItem>
              ...
              <AccordionItem value="managed" className="border border-[#1e1e1e] bg-[#111111] rounded-lg px-5">
                ...
                <AccordionContent className="text-[#9aa0a6] pb-5 leading-relaxed">
                  Your OpenClaw instance runs on cloud infrastructure managed by OpenClaw Box — the same managed hosting service that already handles Telegram-based deployments. You do not buy or maintain any hardware. The instance is always on, auto-updated, and monitored.
                </AccordionContent>
              </AccordionItem>
