        ...
        <div className="grid gap-4 md:grid-cols-4 mt-8">
          <Card className="border-0 shadow-md bg-white/80 backdrop-blur hover:shadow-lg transition-shadow cursor-pointer">
            <CardContent className="p-4 text-center">
              <a href="https://vibeextensioncdn.blob.core.windows.net/extensions/vibe-ai-copilot-latest.zip" target="_blank" rel="noopener noreferrer">
          ...
          <Card className="border-0 shadow-md bg-white/80 backdrop-blur hover:shadow-lg transition-shadow cursor-pointer">
            <CardContent className="p-4 text-center">
              <a href="https://vibeextensioncdn.blob.core.windows.net/extensions/vibe-ai-copilot-latest.crx" target="_blank" rel="noopener noreferrer">
