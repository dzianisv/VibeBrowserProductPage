...
import { SlackDemo, SlackAgent, SlackMessage } from "./slack-demo"
import {
  ArrowRight,
  Users,
  Bot,
    ...
    <div className="flex flex-col min-h-screen bg-[#0a0a0a] text-[#e8eaed] overflow-x-hidden">
      ...
      <header className="w-full px-4 lg:px-6 h-16 flex items-center justify-between border-b border-[#1e1e1e] bg-[#0a0a0a]/95 backdrop-blur-sm sticky top-0 z-50">
        <div className="flex items-center gap-3">
          <img src="/vibebrowser-logo.png" alt="Agent Labs" className="w-9 h-9 object-contain" />
        ...
        <section id="demo" className="w-full py-16 md:py-24 border-t border-[#1e1e1e] bg-[#111111]">
          <div className="container max-w-5xl px-4 md:px-6 mx-auto">
            ...
            <div className="rounded-xl overflow-hidden border border-[#2a2a2a] shadow-2xl bg-[#0a0a0a]">
              ...
              >
                <source src="https://dl.agentlabs.cc/media/agentic-team-cooperation.webm" type="video/webm" />
                <source src="https://dl.agentlabs.cc/media/agentic-team-cooperation.mp4" type="video/mp4" />
        ...
        <section className="w-full py-16 md:py-24 border-t border-[#1e1e1e] bg-[#0a0a0a]">
          <div className="container max-w-6xl px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-12">
              ...
              <div className="rounded-xl overflow-hidden border border-[#2a2a2a] shadow-2xl">
                <img src="https://www.vibebrowser.app/vibeteam2.png" alt="Vibe Team Showcase 2" className="w-full h-auto" />
              </div>
              <div className="rounded-xl overflow-hidden border border-[#2a2a2a] shadow-2xl">
                <img src="https://www.vibebrowser.app/vibeteam3.png" alt="Vibe Team Showcase 3" className="w-full h-auto" />
              </div>
            </div>
          </div>
        </section>
      ...
      <footer className="border-t border-[#1e1e1e] px-4 py-8 text-center text-sm text-[#9aa0a6]">
        <Link href="/" className="hover:text-[#e8eaed]">Agent Labs</Link>
      </footer>
    </div>
  )
}
