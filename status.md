ROADMAP  ██████████████░░░░░░  7/10 done
 ...
 [x] 4. Add failing round-trip tests
 [x] 5. Implement writer fix and UTM limits
 [x] 6. Run focused tests
 [x] 7. Run lint and production build
 [~] 8. Commit, push, and open PR   <-- YOU ARE HERE
 [ ] 9. Wait for all CI terminal green
...
NEXT
 - Rebase latest main, commit, push, open PR
